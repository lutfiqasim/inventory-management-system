...
| GET| /inventory/{id}| Get supplier with id= {id}| `200 OK`: Successfully retrieved the supplier<br> `404 Not found`: inventory with given id not found <br>`500 Internal Server Error`: An error occurred while retrieving the supplier | N/A  | ```json  { "id": "1", "inventory_id": "1","productId": "1","quantity": 50, "last_updated": "2013-01-19 03:14:07" }``` |
